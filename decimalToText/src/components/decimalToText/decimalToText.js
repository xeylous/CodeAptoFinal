...
const DecimalToTextConverter = () => {
  ...
  const convertDecimalToText = () => {
    ...
    try {
      ...
      const decimalNumbers = decimalInput.split(' ').map(num => String.fromCharCode(parseInt(num, 10)));
      const text = decimalNumbers.join('');
      setTextOutput(text);
      setError('');
    } catch (error) {
  ...
  return (
    <div>
      ...
      `}</style>
      <h1 style={{ textAlign: 'center', color: '#33ffff', marginBottom: '20px' ,fontSize : '36px' }}>Decimal to Text Converter</h1>
      <div className="container">
        <div className="button-container">
          ...
          <input
            ...
            id="fileInput"
          />
          <button onClick={convertDecimalToText} className="button convert-button">
            Convert
          </button>
        ...
        <div className="grid-container">
          <div className="decimal-input">
            ...
            <textarea
              className="textarea"
              placeholder="Paste your decimal data here (e.g., 72 101 108 108 111)"
              value={decimalInput}
