...
const HexToDecimalConverter = () => {
  ...
  const convertHexToDecimal = () => {
    ...
    try {
      ...
      const decimal = hexArray
        .map(hex => parseInt(hex, 16).toString(10))
        .join(' ');
      ...
      <div className="container">
        <div className="button-container">
          ...
          <input
            ...
            id="fileInput"
          />
          <button onClick={convertHexToDecimal} className="button convert-button">
            Convert
          </button>
        ...
        <div className="grid-container">
          <div className="hex-input">
            ...
            <textarea
              className="textarea"
              placeholder="Paste your hexadecimal data here (e.g., 1A 3F 4C)"
              value={hexInput}
