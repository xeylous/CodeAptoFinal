...
const BinaryToOctalConverter = () => {
  ...
  const convertBinaryToOctal = () => {
    ...
    try {
      ...
      const octal = binaryArray
        .map(binary => parseInt(binary, 2).toString(8))
        .join(' ');
  ...
  return (
    <div>
      ...
      `}</style>
      <h1 style={{ textAlign: 'center', color: '#33ffff', marginBottom: '20px',fontSize: '36px' }}>Binary to Octal Converter</h1>
      <div className="container">
        <div className="button-container">
          ...
          <input
            ...
            id="fileInput"
          />
          <button onClick={convertBinaryToOctal} className="button convert-button">
            Convert
          </button>
