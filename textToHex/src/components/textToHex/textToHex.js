...
const TextToHex = () => {
  const [fromValue, setFromValue] = useState('text');
  const [toValue, setToValue] = useState('hex');
  ...
  return (
    <div className="flex justify-center items-center bg-transparent">
      <div className="bg-gray-800 text-gray-300 p-8 rounded-lg shadow-lg w-full max-w-3xl">
        <h1 className="text-3xl text-center mb-6 font-bold">Text To Hex Converter</h1>
