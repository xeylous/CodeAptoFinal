...
const SRTConverter = () => {
  ...
  return (
    <>
      <br />
      <h1 className="text-center text-2xl font-bold mb-1 text-sky-300">
        SRT to VTT Converter
      </h1>
      <br />
      <div className="flex flex-col p-6 max-w-md mx-auto bg-gray-800 rounded-lg">
        <h3 className="text-2xl font-bold mb-1 text-gray-100">Select your file</h3>
        <div className="bg-[#4496d9] py-[3px] mb-4 mt-[2px] w-12"></div>
        <div className="w-full mb-6">
          <label className="block mb-4 text-sm text-gray-400">
            Choose a .srt file to convert
          </label>
          <div className="relative">
            <input
              type="text"
              placeholder="No file selected"
              className="block w-full px-3 py-2 text-gray-700 border border-gray-300 rounded-lg cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500"
              readOnly
            ...
            />
            <button
              className="absolute inset-y-0 right-0 px-4 py-2 text-white bg-gray-400 rounded-r-lg hover:bg-gray-500"
        ...
        <h2 className="text-2xl font-bold mb-2 text-gray-100">Converted file format</h2>
        <div className="bg-[#4496d9] py-[3px] mb-4 mt-[2px] w-12"></div>
        <div className="w-full mb-6">
          <label className="block mb-4 text-sm text-gray-400">
            Choose {format || " Select Format "} to convert your file
          </label>
          <select
            value={format}
