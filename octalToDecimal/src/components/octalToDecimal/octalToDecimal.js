...
const OctalToDecimalConverter = () => {
  ...
  const convertOctalToDecimal = () => {
    ...
    try {
      ...
      const decimal = octalArray
        .map(octal => parseInt(octal, 8).toString(10))
        .join(' ');
  ...
  return (
    <div>
      ...
      `}</style>
      <h1 className="text-3xl text-center font-bold text-[#33ffff] mb-5">Octal to Decimal Converter</h1>
      <div className="container">
        <div className="button-container">
          ...
          <input
            ...
            id="fileInput"
          />
          <button onClick={convertOctalToDecimal} className="button convert-button">
            Convert
          </button>
