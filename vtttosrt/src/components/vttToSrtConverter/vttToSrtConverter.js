...
const VTTConverter = () => {
  ...
  return (
    <>
    <h1 className="text-3xl font-bold text-sky-300 text-center my-6">VTT File Converter</h1>
    <div className="flex flex-col p-6 max-w-md mx-auto text-black bg-gray-900 rounded-xl">
      <h2 className="text-2xl font-bold mb-1 text-gray-300">Select your file</h2>
      <div className='bg-[#4496d9] py-[3px] mb-4 mt-[2px] w-12'></div>
      <div className="w-full mb-6">
        <label className="block mb-4 text-sm text-gray-300">Choose a .vtt file to convert</label>
