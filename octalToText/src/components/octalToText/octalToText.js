...
const OctalToTextConverter = () => {
  ...
  return (
    <div>
      ...
      `}</style>
      <h1 className="text-3xl text-center text-[#33ffff] font-bold mb-5">Octal to Text Converter</h1>
      <div className="container">
        <div className="button-container">
          ...
          <input
            ...
            id="fileInput"
          />
          <button onClick={convertOctalToText} className="button convert-button">
            Convert
          </button>
...
export default OctalToTextConverter;