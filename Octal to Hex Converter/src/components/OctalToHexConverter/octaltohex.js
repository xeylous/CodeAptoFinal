...
const OctalToHexConverter = () => {
  ...
  const convertOctalToHex = () => {
    ...
    try {
      ...
      const hex = octalArray
        .map(octal => parseInt(octal, 8).toString(16).toUpperCase())
        .join(' ');
      setHexOutput(hex);
      setError('');
    } catch (error) {
      ...
      <div className="container">
        <div className="button-container">
          ...
          <input
            ...
            id="fileInput"
          />
          <button onClick={convertOctalToHex} className="button convert-button">
            Convert
          </button>
